...
class SignalProcessor(threading.Thread):
    def __init__(self, data_que, module_receiver, logging_level=10):
        ...
        self.theta_0_list = []
        self.DOA_str_list = []
        self.confidence_str_list = []
        self.max_power_level_str_list = []
        self.freq_list = []
                ...
                if en_proc and not self.module_receiver.iq_samples.size:
                    ...
                    try:
                        if self.data_ready:
                            ...
                            self.DOA_str_list.clear()
                            self.confidence_str_list.clear()
                            self.max_power_level_str_list.clear()
                            ...
                            for i in range(active_vfos):
                                ...
                                if (
                                    ...
                                    self.DOA_str_list.append(DOA_str)
                                    self.confidence_str_list.append(confidence_str)
                                    self.max_power_level_str_list.append(max_power_level_str)
                                    ...
                                    self.fm_demod_channel_list.append((record_file_name,
                                                                       fm_demod_channel,
                                                                       iq_channel,
                                                                       thetas))
                            ...
                            if self.DOA_data_format == "Kraken App" or self.en_data_record or \
                                ...
                                for j in range(len(self.freq_list)):
                                    ...
                                    sub_message = ""
                                    sub_message += f"{epoch_time}, {self.DOA_str_list[j]}, {self.confidence_str_list[j]}, {self.max_power_level_str_list[j]}, "
                                    sub_message += f"{self.freq_list[j]}, {self.DOA_ant_alignment}, {self.latency}, {self.station_id}, "
